...
import {
  ...
  getLearningKits,
  getInnovatorPrograms,
  getLocations,
  getVideoData,
} from "@/services/getMockData";
      ...
      <div className="w-full flex items-start justify-center min-h-screen mt-2 max-w-screen overflow-y-clip">
        <div className="w-full pt-2 flex flex-col items-center justify-center h-full">
          ...
          <div className="flex gap-2 flex-col lg:relative w-full h-full lg:h-[600px] items-center justify-center overflow-hidden">
            ...
            >
              <img
                src="/assets/home/banner/map.webp"
                alt="Slide 1"
                className="w-full max-h-[600px] object-cover overflow-clip"
              />
              <img
                  ...
                  tabs={[
                    <div className="flex flex-col items-center justify-center gap-0">
                      ...
                      <div className="text-xs">
                        Free workshop in-person and online
                      </div>
                    </div>,
                    <div className="flex flex-col items-center justify-center gap-0">
                      ...
                      <div className="text-xs flex flex-row gap-2 items-center justify-center">
                        Free trial online{" "}
                        <div
                          className={`w-0.5 h-0.5 bg-red-500 rounded-full ${styles.blink}`}
                        />
                      </div>
                    </div>,
                  ]}
          ...
          <div className="flex flex-col items-center justify-center w-full max-w-6xl px-4 py-8">
            <h1 className="text-3xl font-medium">
              Choose Your Stream Under the Innovator Program
            </h1>
            {/* replace with callout later */}
            <div className="text-lg">
              World-class education at affordable prices! Learning Starts at
              just <span className="font-bold">$99/month</span>!
            </div>
          ...
          <div className="flex flex-col items-center justify-center gap-4 w-full pt-8">
            <h1 className="text-xl md:text-2xl lg:text-3xl font-medium max-w-6xl px-4">
              From Silicon Valley to Singapore—Our In-person Workshops are
              Lighting up 200+ Cities Across the Globe. Attend Now!
            </h1>
          ...
          <div className="w-full bg-brand-purple-dark h-fit py-3 text-white text-sm sm:font-md md:text-lg text-center px-4 md:px-8 lg:px-16 xl:px-32">
            <p>
              ...
              through our robotics and math workshops, and provided
              <span className="font-bold text-brand-yellow">
                {" "}
                14,000 students
              </span>{" "}
              with complimentary trial sessions.
            </p>
          </div>
          ...
          <Callout className="mt-8 text-lg text-center">
            ...
            <a
              href="https://moonpreneur.com/resources/partners"
              className="underline text-brand-purple hover:text-brand-purple/90"
            >
              learn more
            </a>
            .
          ...
          <div className="mt-8 flex flex-col w-full items-center justify-center gap-12">
            ...
            >
              <div className="flex-1/2 flex flex-col gap-2 items-start justify-start !h-full">
                ...
                <p className="mt-2">
                  Our Innovator Program aligns with future demands, training
                  students in essential futuristic skills such as AI/ML,
                  Robotics, Big Data, and App development.
                </p>
              </div>
              ...
              <div className="flex-1/2 flex flex-col gap-8 items-start justify-start h-full">
                ...
                <p className="-mt-4">
                  Analytical thinking, logic & algorithm building, electronic
                  components, coding, design thinking, and prototyping.
                </p>
                ...
                <p className="-mt-4">
                  Creative thinking, leadership, talent management, design and
                  user experience, empathy and active listening, and financial
                  literacy.
                </p>
                ...
                <p className="-mt-4">
                  Advanced Math: Hands-on mathematical operations, fractions,
                  and word problems for building real-life applications.
                </p>
              </div>
            </div>
            ...
            >
              <div className="flex-1/2 flex flex-col gap-2 items-start justify-start !h-full">
                ...
                <p className="mt-2">
                  Moonpreneur focuses on experiential learning because it allows
                  children to feel, observe the process, and build an
                  understanding of the concepts involved in turning ideas into
                  products.
                  <br />
                  <br />
                  The initial stage, which is nine months long, focuses on
                  inculcating technical skills. Children learn and understand
                  the technical aspects while using the Online Simulator. Next,
                  they move on to the Embedded Learner Board and Arduino Uno,
                  which introduces them to other components involved in building
                  a project. This process piques the interest of children.
                </p>
              </div>
            ...
            >
              <div className="flex-1/2 flex flex-col gap-2 items-start justify-start !h-full">
                ...
                <p className="mt-2">
                  The Prototyping stage is a dynamic three-month journey where
                  students bring their product ideas to life using Moonpreneur’s
                  specialized kits. Through Tiers Zero to Four, they progress
                  from basic tools like Micro:bit and sensors to advanced
                  technologies like Arduino Uno. Applying the 5-Step Design
                  Thinking Process—empathize, define, ideate, prototype, and
                  test—students master soldering, programming, and design. By
                  the end, they transform their innovative ideas into functional
                  prototypes.
                </p>
              </div>
              <div className="flex-1/2 flex flex-col gap-8 items-start justify-start h-full"></div>
            ...
            >
              <div className="flex-1/2 flex flex-col gap-2 items-start justify-start !h-full">
                ...
                <p className="mt-2">
                  At Moonpreneur, "POWER SKILLS" blend soft and hard skills to
                  create an engaging, future-ready program for children.
                  <br />
                  <span className="font-medium">Team Building</span>: We foster
                  collaboration, communication, and goal-oriented teamwork.
                  <br />
                  <br />
                  <span className="font-medium">Design Thinking </span>
                  <br />
                  Children learn the five-step process (empathize, define,
                  ideate, prototype, test) to solve problems creatively.
                  <br />
                  <span className="font-medium">Business Plan Preparation</span>
                  : We teach kids how to develop and present business plans to a
                  global audience.
                </p>
              </div>
              <div className="flex-1/2 flex flex-col gap-8 items-start justify-start h-full"></div>
          ...
          <div className="mt-8 flex flex-col w-full items-center justify-center gap-12 bg-brand-blue">
            ...
            >
              <div className="flex-1/2 flex flex-col gap-2 items-start justify-start !h-full">
                ...
                <p className="mt-2">
                  MoonBattle is the flagship competition organized by
                  Moonpreneur for students aged 7-18 years as part of its
                  Innovator Program. It aims to provide project-based learning
                  and leadership training to students. The competition requires
                  participants to work in teams and develop innovative projects.
                  Teams pitch their projects to a global jury of angel
                  investors, successful entrepreneurs, and subject matter
                  experts. MoonBattle provides students with valuable experience
                  in critical thinking, problem-solving, leadership, and
          ...
          <div className="flex flex-col w-full items-center justify-center gap-8 px-8 py-16 bg-[#F4E8F0]">
            <div className="w-3/4 md:w-1/2 flex flex-col items-center justify-center gap-4">
              <h1 className=" text-2xl font-semibold text-center">
                Experiential Learning Kits from Moonpreneur
              </h1>
              <h2 className=" text-base md:text-lg text-center font-base">
                Moonpreneur Innovation Lab creates unique learning kits for
                hands-on learning for children. These kits are also a part of
                our curriculum.
              </h2>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 w-full max-w-6xl px-4">
              {learningKits.map((kit, index) => (
                ...
                >
                  <a
                    href={kit.link}
                    className="w-fit rounded-full bg-white p-8 aspect-square flex items-center justify-center hover:scale-105 transition-transform duration-300"
                  >
                    <img
                      src={kit.img}
                      alt={kit.name + " - " + kit.description}
                      className="w-36"
                    />
                  </a>
                  <a
