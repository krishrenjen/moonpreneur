      ...
      <div className="bg-brand-blue text-white text-center py-2 min-h-20 flex items-center justify-between gap-2 px-2">
        <div className="flex flex-row items-center justify-start gap-1 md:gap-2 w-fit">
          <div className="flex-row gap-1 justify-center items-center my-2 hidden lg:flex">
            <CircleImage
              src="/assets/home/countries/us.png"
              alt={"United States Flag"}
            />
            <CircleImage
              src="/assets/home/countries/uk.png"
              alt={"United Kingdom Flag"}
            />
            <CircleImage
              src="/assets/home/countries/canada.png"
              alt={"Canada Flag"}
            />
            <CircleImage
              src="/assets/home/countries/australia.png"
              alt={"Australia Flag"}
            />
            <CircleImage
              src="/assets/home/countries/germany.png"
              alt={"Germany Flag"}
            />
            <CircleImage
              src="/assets/home/countries/netherlands.png"
              alt={"Netherlands Flag"}
            />
          </div>
          <p className="flex-1 text-sm md:text-base !font-bold w-full p-0 m-0">
            Attend our in-person Robotics & Math{" "}
            <span className="text-yellow-200">FREE WORKSHOP</span> for your
            child <span className="font-normal">(7-18 yrs old)</span>
          </p>
        ...
        <div className="flex items-center justify-between w-full mx-auto px-4 md:px-8 bg-white h-24">
          ...
          >
            ...
            <div className="sm:hidden flex items-center justify-center">
              <img
                src="/assets/svgs/moonpreneur-logo-small.png"
                className="h-16"
              />
            </div>
          </Link>
          ...
          <div className="flex items-center justify-center gap-4">
            <div className="items-center justify-center gap-2 flex lg:hidden">
              <BrandButton
                href="/login"
                variant="outline"
                className="w-fit px-2 !py-1 text-sm md:text-base"
                newTab
                hoverEffect
                clickEffect
              >
              ...
              <BrandButton
                href="/login"
                variant="primary"
                className="w-fit !py-1 text-sm md:text-base px-8"
